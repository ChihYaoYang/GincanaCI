        ...
        <div class="container">
            <div class="row">
                <div class="col"><div class="col-8 offset-md-2">
                        <!---Card--->
                        <div class="card">
                            <h3 class="card-header bg-transparent"><i class="fas fa-arrow-left"></i> <a href="http://127.0.0.1/GincanaCI/index.php/Prova/listar">Back</a><br><i class="fas fa-edit"></i>Formulário da Prova</h3>
                            <div class="card-body">  
