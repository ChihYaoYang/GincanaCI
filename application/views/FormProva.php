            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="menuCliente">
                        <a href="<?= $this->config->base_url() . 'index.php/Prova/listar' ?>"
                            class="dropdown-item">Listar</a>
                        <a href="<?= $this->config->base_url() . 'index.php/Prova/cadastrar' ?>"
                ...
                <div class="col-8 offset-md-2">
                    ...
                    <div class="card">
                        <h3 class="card-header bg-transparent"><i class="fas fa-arrow-left"></i> <a
                                href=<?= $this->config->base_url() . 'index.php/Prova/listar' ?>>Back</a><br><i
