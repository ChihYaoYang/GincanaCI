            ...
            <div class="row">
                <div class="col">  
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <a class="navbar-brand" href="http://127.0.0.1/GincanaCI/index.php/Prova/listar"><i class="fab fa-bootstrap h1" style="color: red;"></i></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item active">
                                    <a class="nav-link btn btn-primary text-white mr-2" href="http://127.0.0.1/GincanaCI/index.php/Prova/listar">Home <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link btn btn-warning text-white" href="http://127.0.0.1/GincanaCI/index.php/Prova/cadastrar">Cadastrar</a>
                                </li>
