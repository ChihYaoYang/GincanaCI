                    ...
                    <tbody>
                        ...
                        if (count($integrante) > 0) {
                            foreach ($integrante as $integ) {
                                ...
                                echo '<td class="text-right">' . '<a class="btn btn-sm btn-outline-danger mr-2 confirm" href="' . base_url() . 'Integrante/deletar/' . $integ->id . '"><i class="fas fa-trash-alt"></i> Delete</a>' .
